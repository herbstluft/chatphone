...
<div class="col-12" style="background-color:#f6f9fb; overflow-x:hidden; overflow-y:scroll; height:auto; padding:2%">
  <p style="font-size: 24px; font-weight: 600; margin-top:3%; margin-left:5%">Ajustes</p>
...
   <span style="--bs-text-opacity: 1;color: rgb(191, 204, 223) !important;font-size: 0.875em;">Seguridad</span>
<br><br>
<div class="card border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center gx-5">
